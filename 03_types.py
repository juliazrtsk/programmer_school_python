...
# Точка после имени переменной указывает на то, что мы пытаемся обратиться к объекту и что-то от него получить.
...
# Поэтому некоторым действиям мы эту дополнительную информацию сообщаем. Эта информация называется "аргументы"
