...
# Ниже представлен код для рисования шестиугольника. Вы это уже хорошо знаете
t.forward(step)
t.left(angle)
t.forward(step)
t.left(angle)
...
# А что если нам нужно нарисовать много таких шестиугольников на одном рисунке? Например, 100 штук.
...
# Цикл — повторение одного кусочка кода много раз.
# Ту команду, которую мы передадим циклу, он выполнит несколько раз. Число раз мы задаём сами. Пример
for i in range (1, 5):
    print('Люблю программировать') # Эта строчка отработает 4 раза
