# Первая структура данных, которую мы изучим: массив
...
# Последняя важная вещь в этом уроке
# Будьте внимательны при обращении к элементу массива по индексу
# Если вы попытаетесь получить элемент по номеру, которого в массиве нет, получите ошибку
# print(numbers[10])
# Если вы уберёте символ коммментария (# ) и попробуете запустить этот код, получите ошибку
# Длина массива numbers = 5. Если мы пытаемся получить 10й элемент массива, то, логично, не находим его.